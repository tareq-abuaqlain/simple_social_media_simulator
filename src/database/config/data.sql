...
DROP TABLE IF EXISTS user, post, comment, reply, watch;
...
INSERT INTO user (username, email, password) VALUES ('user1', 'user1@localhost', '123456'), ('user2', 'user2@localhost', '123456');
